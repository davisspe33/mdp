...
def plotmodelLearn(x,y):
    ...
    train_sizes, train_scores, test_scores, fit_times, _ = learning_curve(tree.DecisionTreeRegressor(random_state=0, max_depth=3), x, y, train_sizes=train_sizes, return_times=True)
    train_scores_mean = np.mean(train_scores, axis=1)
